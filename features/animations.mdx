---
title: "Animations: Keyframe Timeline with 35+ Motion Presets"
sidebarTitle: "Animations"
description: "Animate screenshots with a professional keyframe timeline, 35+ motion presets across 8 categories, 8 easing functions, and multi-slide looping support."
---
...
<CardGroup cols={3}>
  ...
  <Card title="Preset Library" icon="layer-group">
    `lib/animation/presets.ts` defines 35+ named presets as arrays of `AnimationTrack` objects, each containing timed `Keyframe` entries.
  </Card>
...
35+ presets are organized into 8 categories. Apply any preset from the `AnimationPresetGallery` component — it clones the preset's tracks with fresh IDs and places them on the timeline.
