---
title: "Export: PNG, MP4, WebM & GIF with Hardware Acceleration"
sidebarTitle: "Export"
description: "Export screenshots as PNG/JPG up to 5× scale or videos as MP4, WebM, and GIF using WebCodecs, FFmpeg WASM, and MediaRecorder — all fully in-browser."
---
...
Static screenshots can be exported as **PNG** or **JPG** at up to **5× scale**:

<CardGroup cols={3}>
  <Card title="Format" icon="file-image">
    **PNG** preserves transparency (useful when the background is set to transparent). **JPG** produces smaller files at the cost of the alpha channel.
  </Card>
  ...
  <Card title="Quality Slider" icon="sliders">
    For JPG exports, a 0–1 quality slider controls JPEG compression. Values above 0.85 are visually lossless for most screenshots; lower values trade quality for file size.
  </Card>
</CardGroup>
...
// IndexedDB schema for exported files
{
  ...
  format: string;      // 'png' | 'jpg' | 'mp4' | 'webm' | 'gif'
