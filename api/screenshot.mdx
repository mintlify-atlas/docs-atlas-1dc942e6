...
The route has a `maxDuration` of **60 seconds** (configured in `vercel.json`) to accommodate slow websites and Playwright startup time on cold starts. Memory is set to 1024 MB.
